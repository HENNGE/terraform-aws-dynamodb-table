...
resource "aws_dynamodb_table" "replica_ignore" {
...
resource "aws_dynamodb_table" "autoscaled_replica_ignore" {
...
resource "aws_dynamodb_table" "autoscaled_gsi_ignore_replica_ignore" {
  count = var.create_table && var.autoscaling_enabled && var.ignore_changes_global_secondary_index && var.ignore_changes_replica ? 1 : 0
